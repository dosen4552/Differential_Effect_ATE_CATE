...
generate_plot = function(n = 5000,d = 20, delta = 1, p = 0.9, folder = 1){
  m1 = 'homo'
  m2 = 'heter'
  path = '/Users/kanchen/Dropbox/kan_bingkai_dylan/Differential_Effect/Simulation/'
  ...
  lines(xlist,upper.catelist1,type = "l", lty=2, lwd=3)
  lines(xlist,lower.catelist1,type = "l", lty=4, lwd=3)
  
  legend("topleft", inset=c(0.12, 0.01), legend=c("True", "Upper","Lower"),
         col=c("black", "black","black"), lty=c(1,2,4), cex=0.6,box.col = "white")
  ...
  lines(xlist,upper.catelist2,type = "l", lty=2, lwd=3)
  lines(xlist,lower.catelist2,type = "l", lty=4, lwd=3)
  legend("topleft", inset=c(0.12, 0.01), legend=c("True", "Upper","Lower"),
         col=c("black", "black","black"), lty=c(1,2,4), cex=0.6,box.col = "white")
